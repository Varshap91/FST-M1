...
public class Activity9 {
    ...
    public void addNewJobTest() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.id("post-title-0")).sendKeys("Junior Engineer");
        Thread.sleep(2000);
        ...
        Assert.assertEquals(publishedMessage, "Junior Engineer is now live.");

        // Validate newly created job reflects in Jobs screen
        driver.get("https://alchemy.hguy.co/jobs/jobs/");
        driver.findElement(By.id("search_keywords")).sendKeys("Junior Engineer");
        ...
        Assert.assertEquals(jobName, "Junior Engineer");
        System.out.println("Junior Engineer Job is posted successfully");
    }
